...
import (
	...
	relation "github.com/quangpham789/golang-assessment/service/relation"
...
func (_m *RelationServ) isRelationExist(ctx context.Context, requesterID int, addresseeID int, relationType int) (bool, error) {
...
// isValidToCreateRelation provides a mock function with given fields: ctx, requesterID, addresseeID, relationType
func (_m *RelationServ) isValidToCreateRelation(ctx context.Context, requesterID int, addresseeID int, relationType int) (bool, error) {
	ret := _m.Called(ctx, requesterID, addresseeID, relationType)
